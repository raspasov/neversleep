(ns neversleep-db.persistent-durable-vector
  (:require [neversleep-db.util :as util]
            ...
            [neversleep-db.protobuf-protocol :refer :all]
            [neversleep-db.persistent-durable-vector-protocol :refer :all]
...
(deftype VectorNode [array uuid blob-identifier]
  ProtobufNode
  DurableVectorNode
