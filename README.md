...
NeverSleep uses third party storage backends to store your data. Currently there's support only for **MySQL**.
Support for **DynamoDB** and other SQL-compatible servers is coming soon.
