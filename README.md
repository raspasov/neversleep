...
Optionally (but strongly recommended), edit **/etc/neversleep-db/jvm-config** to specify your JVM heap size; **Xms** and **Xmx** values are strongly recommended to be the same. The default heap size specified in jvm-config is 256MB.
